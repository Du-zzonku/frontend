...
export function StudyLeftPanel({
  ...
  return (
    <aside
      className="w-[394px] shrink-0 flex flex-col overflow-hidden rounded-[20px] border border-[#595959]/50 my-3 ml-3"
      style={{
        background:
    ...
    >
      ...
      <div className="px-6 mt-8">
        <h1 className="text-[2.5rem] font-extrabold text-white leading-tight">
          {model.nameKo}
        </h1>
      </div>
